...
(function() {
  var SQS, crypto, iced, qs, request, url, xml, __iced_k, __iced_k_noop;
  ...
  exports.SQS = SQS = (function() {

    function SQS(_arg) {
      this.accessKeyId = _arg.accessKeyId, this.secretAccessKey = _arg.secretAccessKey, this.awsHost = _arg.awsHost, this.owner = _arg.owner, this.topic = _arg.topic;
      if (!this.awsHost) this.awsHost = 'queue.amazonaws.com';
    }

    SQS.prototype.hmac = function(str) {
      var hash;
    ...
    SQS.prototype.makeAuth = function(now) {
      var auth, auth_pairs, v;
      auth_pairs = [["AWSAccessKeyId", this.accessKeyId], ["Algorithm", "HmacSHA256"], ["Signature", this.hmac(now)]];
    ...
    SQS.prototype.makeHeaders = function(_arg) {
    ...
    SQS.prototype.call = function(query, callback) {
      var auth, body, data, err, headers, now, parser, pathname, req, response, uri, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      pathname = [this.owner, this.topic].join("/");
    ...
    SQS.prototype.receiveMessage = function(cb) {
